(function initializeDom(global) {
  ...
  AtlasApp.createElements = function createElements() {
    return {
      ...
      flashcardScope: document.querySelector("#flashcard-scope"),
      flashcardTagWrapper: document.querySelector("#flashcard-tag-wrapper"),
      flashcardTag: document.querySelector("#flashcard-tag"),
      flashcardAmount: document.querySelector("#flashcard-amount"),
      flashcardReversed: document.querySelector("#flashcard-reversed"),
      generateFlashcardsButton: document.querySelector("#generate-flashcards-button"),
      flashcardTitle: document.querySelector("#flashcard-title"),
      flashcardProgress: document.querySelector("#flashcard-progress"),
      flashcardCard: document.querySelector("#flashcard-card"),
      flashcardFlipButton: document.querySelector("#flashcard-flip-button"),
      flashcardPrevButton: document.querySelector("#flashcard-prev-button"),
      flashcardNextButton: document.querySelector("#flashcard-next-button"),
      flashcardSummary: document.querySelector("#flashcard-summary"),
