(function initializeDom(global) {
  ...
  AtlasApp.createElements = function createElements() {
    return {
      ...
      sidebarNewFolderToggle: document.querySelector("#sidebar-new-folder-toggle"),
      sidebarFolderForm: document.querySelector("#sidebar-folder-form"),
      sidebarFolderName: document.querySelector("#sidebar-folder-name"),
      sidebarFolderCancel: document.querySelector("#sidebar-folder-cancel"),
      sidebarFolderError: document.querySelector("#sidebar-folder-error"),
      ...
      todoPageForm: document.querySelector("#todo-page-form"),
      todoPageInput: document.querySelector("#todo-page-input"),
      todoPageAddButton: document.querySelector("#todo-page-add-button"),
      todoPageList: document.querySelector("#todo-page-list"),
      todoPageCount: document.querySelector("#todo-page-count"),
      ...
      panels: {
        ...
        todos: document.querySelector("#todos-tab"),
      ...
      editorPanelHeader: document.querySelector(".panel-editor > .panel-header"),
      editorTitleField: document.querySelector(".editor-title-field"),
      editorMetadataPanel: document.querySelector("#editor-metadata-panel"),
      editorUpdatedAt: document.querySelector("#editor-updated-at"),
      editorQuestionsButton: document.querySelector("#editor-questions-button"),
      ...
      quizBankPanel: document.querySelector(".quiz-bank-panel"),
      ...
      sportExerciseAssist: document.querySelector("#sport-exercise-assist"),
      sportAssistLabel: document.querySelector("#sport-assist-label"),
      sportExerciseSuggestions: document.querySelector("#sport-exercise-suggestions"),
      sportLastPerformance: document.querySelector("#sport-last-performance"),
      sportRowMenu: document.querySelector("#sport-row-menu"),
      sportRowMenuLabel: document.querySelector("#sport-row-menu-label"),
      sportPerformanceTable: document.querySelector(".sport-performance-table"),
      sportZoomOut: document.querySelector("#sport-zoom-out"),
      sportZoomIn: document.querySelector("#sport-zoom-in"),
      sportZoomLabel: document.querySelector("#sport-zoom-label"),
